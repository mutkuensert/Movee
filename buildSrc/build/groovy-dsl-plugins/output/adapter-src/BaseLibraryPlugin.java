...
/**
 * Precompiled base-library script plugin.
 **/
public class BaseLibraryPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BaseLibrary").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("base-plugin");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BaseLibrary").asSubclass(BasicScript.class);
